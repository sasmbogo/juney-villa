...
<nav aria-label="breadcrumb"><ol class="breadcrumb small"><li class="breadcrumb-item"><a href="<?= url('/blog') ?>">Blog</a></li><li class="breadcrumb-item active"><?= e($blog['title']) ?></li></ol></nav>
