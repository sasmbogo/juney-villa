...
<div class="col-md-4"><div class="card border-0 shadow-sm rounded-3 h-100"><img src="<?= e($blog['featured_image'] ?? 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400') ?>" class="card-img-top" style="height:200px;object-fit:cover"><div class="card-body"><h5 class="fw-bold"><?= e($blog['title']) ?></h5><p class="text-muted small"><?= e(truncate($blog['excerpt'] ?? '', 100)) ?></p><a href="<?= url('/blog/' . e($blog['slug'])) ?>" class="btn btn-sm btn-outline-dark">Read More</a></div></div></div>
<?php endforeach; ?>
