        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/dashboard') ? 'active' : '' ?>" href="/admin/dashboard">
                            <i class="bi bi-speedometer2"></i><span>Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/bookings') ? 'active' : '' ?>" href="/admin/bookings">
                            <i class="bi bi-calendar-check"></i><span>Bookings</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/villas') ? 'active' : '' ?>" href="/admin/villas">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/users') ? 'active' : '' ?>" href="/admin/users">
                            <i class="bi bi-people"></i><span>Users</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/reviews') ? 'active' : '' ?>" href="/admin/reviews">
                            <i class="bi bi-star"></i><span>Reviews</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/housekeeping') ? 'active' : '' ?>" href="/admin/housekeeping">
                            <i class="bi bi-house-check"></i><span>Housekeeping</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/maintenance') ? 'active' : '' ?>" href="/admin/maintenance">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/gallery') ? 'active' : '' ?>" href="/admin/gallery">
                            <i class="bi bi-images"></i><span>Gallery</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'] ?? '', '/admin/coupons') ? 'active' : '' ?>" href="/admin/coupons">
        ...
        <div class="admin-main">
            ...
            <header class="admin-topbar">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="/admin/notifications" class="btn btn-sm position-relative">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="/guest/profile"><i class="bi bi-person me-2"></i>Profile</a></li>
